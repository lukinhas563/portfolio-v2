...
describe("<IconTailwind />", () => {
  ...
  test("renders with correct props", () => {
    ...
    render(<IconTailwind width={width} color={color} className={className} />);
    ...
    expect(screen.getByText("Icode de habilidade em Tailwind")).toBeDefined();
  });
});
