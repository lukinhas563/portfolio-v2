...
import IconHalfArrowUp from "./IconHalfArrowUp";

describe("<IconHalfArrowUp />", () => {
  afterEach(cleanup);
  ...
  test("renders with correct props", () => {
    ...
    expect(screen.getByText("Meia Seta para cima")).toBeDefined();
    expect(screen.getByText("Icone de meia seta para cima")).toBeDefined();
  });
});
