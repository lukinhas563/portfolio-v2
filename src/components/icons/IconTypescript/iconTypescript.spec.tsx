...
describe("<IconTypescript />", () => {
  ...
  test("renders with correct props", () => {
    ...
    render(
      <IconTypescript width={width} color={color} className={className} />
    );
    ...
    expect(screen.getByText("Icode de habilidade em Typescript")).toBeDefined();
  });
});
