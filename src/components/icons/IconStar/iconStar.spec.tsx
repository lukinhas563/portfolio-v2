...
describe("<IconStar />", () => {
  ...
  test("renders with correct props", () => {
    ...
    render(<IconStar width={width} color={color} className={className} />);
    ...
    expect(screen.getByText("Estrela")).toBeDefined();
    expect(screen.getByText("Icone de estrela")).toBeDefined();
  });
});
