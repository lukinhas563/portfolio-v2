...
import IconFirebase from "./IconFarebase";

describe("<IconFirebase />", () => {
  afterEach(cleanup);
  ...
  test("renders with correct props", () => {
    ...
    render(<IconFirebase width={width} color={color} className={className} />);
    ...
    expect(screen.getByText("Icode de habilidade em Firebase")).toBeDefined();
  });
});
